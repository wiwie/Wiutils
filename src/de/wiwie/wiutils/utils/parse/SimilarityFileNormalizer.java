...
public class SimilarityFileNormalizer extends SimFileParser {
	...
	public static void main(final String[] args) {
		try {
			...
			final SimilarityFileNormalizer no = new SimilarityFileNormalizer(
					"/home/wiwiec/git/clusteval/clusteval/repository/data/datasets/astral_40/ASTRAL-small-sized-mammoth-sims-geq-2.txt.strip",
					SIM_FILE_FORMAT.ID_ID_SIM,
					"/home/wiwiec/git/clusteval/clusteval/repository/data/datasets/astral_40/ASTRAL-small-sized-mammoth-sims-geq-2.txt.strip.norm2",
					1.0);
			no.process();
